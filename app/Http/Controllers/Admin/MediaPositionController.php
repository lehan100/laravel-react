...
class MediaPositionController extends MainController
{
    ...
    public function store(MediaPositionStoreRequest $request)
    {
        ...
        try {
            ...
            if ($params['undo'] == 1) {
                return Redirect::to(route($this->routeName . 'index'))->with('success', __('hancms.message.success.created', ['name' => __('hancms.media.position.name')]));
            }
            return Redirect::route($this->routeName . 'edit', $language->id)->with('success', __('hancms.message.success.created', ['name' => __('hancms.media.position.name')]));
        } catch (\Throwable $th) {
            //throw $th;
            return Redirect::back()->with('error',  __('hancms.message.error.created', ['name' => __('hancms.media.position.name')]));
        }
    }
    ...
    public function update(MediaPositionUpdateRequest $request, string $id)
    {
        ...
        try {
            ...
            if ($params['undo'] == 1) {
                return Redirect::to(route($this->routeName . 'index'))->with('success', __('hancms.message.success.edit', ['name' => __('hancms.media.position.name')]));
            }
            return Redirect::route($this->routeName . 'edit', $language->id)->with('success', __('hancms.message.success.edit', ['name' => __('hancms.media.position.name')]));
        } catch (\Throwable $th) {
            //throw $th;
            return Redirect::back()->with('error',  __('hancms.message.error.edit', ['name' => __('hancms.media.position.name')]));
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return Redirect::back()->with('success', __('hancms.message.success.deleted', ['name' => __('hancms.media.position.name')]));
        } catch (\Throwable $th) {
    ...
    public function destroyMany(Request $request): RedirectResponse
    {
        try {
            ...
            return Redirect::route($this->routeName . 'index')->with('success', __('hancms.message.success.deleted', ['name' => __('hancms.media.position.name')]));
        } catch (\Throwable $th) {
