...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\Language\LanguageRepositoryInterface' => \App\Repositories\Language\LanguageEloquentRepository::class,
            'App\Repositories\User\UserRepositoryInterface' => \App\Repositories\User\UserEloquentRepository::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\wamp64\www\laravel-react\public\storage' => 'string',
            ...
            'configs.prefix.admin' => 'string',
            'configs.prefix.frontend' => 'string',
            'configs.user_group_name' => 'array',
            ...
            'image.driver' => 'string',
            'image.sizes.product.small' => 'array',
            'image.sizes.product.medium' => 'array',
            'image.sizes.product.large' => 'array',
            'image.sizes.option' => 'array',
            'image.sizes.attribute_set' => 'array',
            'image.sizes.category' => 'array',
            'image.sizes.post' => 'array',
            'image.sizes.photo' => 'array',
            'image.sizes.rating' => 'array',
            'image.admin.product.width' => 'integer',
            'image.admin.product.height' => 'integer',
            'image.admin.category.width' => 'integer',
            'image.admin.category.height' => 'integer',
            'image.admin.post.width' => 'integer',
            'image.admin.post.height' => 'string',
            'image.admin.photo.width' => 'integer',
            'image.admin.photo.height' => 'string',
            'image.admin.rating.width' => 'integer',
            'image.admin.rating.height' => 'integer',
            'image.admin.attribute_set.width' => 'integer',
            'image.admin.attribute_set.height' => 'string',
            'image.path.wysiwyg.path' => 'string',
            'image.path.product.temp' => 'string',
            'image.path.product.path' => 'string',
            'image.path.product.trash' => 'string',
            'image.path.product.size' => 'string',
            'image.path.product_option.temp' => 'string',
            'image.path.product_option.path' => 'string',
            'image.path.product_option.trash' => 'string',
            'image.path.product_option.size' => 'string',
            'image.path.attribute_set.temp' => 'string',
            'image.path.attribute_set.path' => 'string',
            'image.path.attribute_set.trash' => 'string',
            'image.path.attribute_set.size' => 'string',
            'image.path.category.temp' => 'string',
            'image.path.category.path' => 'string',
            'image.path.category.trash' => 'string',
            'image.path.category.size' => 'string',
            'image.path.post.temp' => 'string',
            'image.path.post.path' => 'string',
            'image.path.post.thumb' => 'string',
            'image.path.post.trash' => 'string',
            'image.path.post.size' => 'string',
            'image.path.photo.temp' => 'string',
            'image.path.photo.path' => 'string',
            'image.path.photo.trash' => 'string',
            'image.path.photo.size' => 'string',
            'image.path.rating.temp' => 'string',
            'image.path.rating.path' => 'string',
            'image.path.rating.thumb' => 'string',
            'image.path.rating.trash' => 'string',
            'image.path.rating.size' => 'string',
...
'app.aliases.View','app.aliases.Vite','broadcasting.default','broadcasting.connections.reverb.driver','broadcasting.connections.reverb.key',
...
'filesystems.disks.s3.report','filesystems.links.C:\\wamp64\\www\\laravel-react\\public\\storage','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify',
...
'session.same_site','session.partitioned','view.paths','view.compiled','auth.defaults.guard',
...
'auth.password_timeout','configs.prefix.admin','configs.prefix.frontend','configs.user_group_name','database.default',
...
'database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','image.driver','image.sizes.product.small',
'image.sizes.product.medium','image.sizes.product.large','image.sizes.option','image.sizes.attribute_set','image.sizes.category',
'image.sizes.post','image.sizes.photo','image.sizes.rating','image.admin.product.width','image.admin.product.height',
'image.admin.category.width','image.admin.category.height','image.admin.post.width','image.admin.post.height','image.admin.photo.width',
'image.admin.photo.height','image.admin.rating.width','image.admin.rating.height','image.admin.attribute_set.width','image.admin.attribute_set.height',
'image.path.wysiwyg.path','image.path.product.temp','image.path.product.path','image.path.product.trash','image.path.product.size',
'image.path.product_option.temp','image.path.product_option.path','image.path.product_option.trash','image.path.product_option.size','image.path.attribute_set.temp',
'image.path.attribute_set.path','image.path.attribute_set.trash','image.path.attribute_set.size','image.path.category.temp','image.path.category.path',
'image.path.category.trash','image.path.category.size','image.path.post.temp','image.path.post.path','image.path.post.thumb',
'image.path.post.trash','image.path.post.size','image.path.photo.temp','image.path.photo.path','image.path.photo.trash',
'image.path.photo.size','image.path.rating.temp','image.path.rating.path','image.path.rating.thumb','image.path.rating.trash',
'image.path.rating.size','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist','inertia.page_paths',
...
'inertia.history.encrypt','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.scheme','mail.mailers.smtp.url',
...
'mail.mailers.failover.mailers','mail.mailers.failover.retry_after','mail.mailers.roundrobin.transport','mail.mailers.roundrobin.mailers','mail.mailers.mailgun.transport',
...
'fortify.lowercase_usernames','fortify.limiters.login','fortify.paths.login','fortify.paths.logout','fortify.paths.password.request',
...
'signed','throttle','verified','check.login','role',
...
'two-factor.regenerate-recovery-codes','sanctum.csrf-cookie','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','photo.upload','auth/login','auth/post-login',
'auth/logout','dashboard','roles.index','roles.create','roles.store',
'roles.show','roles.edit','roles.update','roles.destroy','roles.destroyMany',
'roles.permissions','users.index','users.create','users.store','users.show',
'users.edit','users.update','users.destroy','users.destroyMany','languages.index',
'languages.create','languages.store','languages.show','languages.edit','languages.update',
'languages.destroy','languages.destroyMany','lang.switch','organizations','organizations.create',
'organizations.store','organizations.edit','organizations.update','organizations.destroy','organizations.restore',
'contacts','contacts.create','contacts.store','contacts.edit','contacts.update',
'contacts.destroy','contacts.restore','reports','image','storage.local',);
...
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'C:.wamp64.www.laravel-react.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name','auth.failed','auth.throttle','pagination.previous','pagination.next',
'passwords.password','passwords.reset','passwords.sent','passwords.token','passwords.user',
'validation.accepted','validation.active_url','validation.after','validation.after_or_equal','validation.alpha',
...
'validation.confirmed','validation.date','validation.date_equals','validation.date_format','validation.different',
...
'validation.lte.string','validation.lte.array','validation.max.numeric','validation.max.file','validation.max.string',
'validation.max.array','validation.mimes','validation.mimetypes','validation.min.numeric','validation.min.file',
'validation.min.string','validation.min.array','validation.not_in','validation.not_regex','validation.numeric',
...
'PUSHER_APP_SECRET','PUSHER_APP_CLUSTER','VITE_APP_NAME','VITE_PUSHER_APP_KEY','VITE_PUSHER_APP_CLUSTER',);
