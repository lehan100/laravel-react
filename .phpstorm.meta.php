...
'database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','inertia.ssr.enabled','inertia.ssr.url',
...
'inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','mail.default','mail.mailers.smtp.transport',
...
'permission.enable_wildcard_permission','permission.cache.expiration_time','permission.cache.key','permission.cache.store','sanctum.stateful',
...
'services.mailgun.endpoint','services.mailgun.scheme','fortify.guard','fortify.middleware','fortify.auth_middleware',
...
'fortify.redirects.password-reset','fortify.features','flare.key','flare.flare_middleware','flare.flare_middleware.Spatie\\LaravelIgnition\\FlareMiddleware\\AddLogs.maximum_number_of_collected_logs',
...
'two-factor.regenerate-recovery-codes','sanctum.csrf-cookie','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','auth/login','auth/post-login','auth/logout',
'dashboard','roles.index','roles.create','roles.store','roles.show',
'roles.edit','roles.update','roles.destroy','roles.destroyMany','roles.permissions',
'users.index','users.create','users.store','users.show','users.edit',
'users.update','users.destroy','users.destroyMany','organizations','organizations.create',
