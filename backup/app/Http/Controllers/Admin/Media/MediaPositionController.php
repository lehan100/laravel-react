...
use App\Http\Requests\Media\MediaPositionStoreRequest;
use App\Http\Requests\Media\MediaPositionUpdateRequest;
use App\Http\Resources\Media\MediaPositionCollection;
use App\Http\Resources\Media\MediaPositionResource;
...
{
    protected string $controllerView = 'Admin/MediaPosition/';

    protected string $routeName = 'media-position.';
