...
const index9164e9249fd166146864f43fcd1f6506 = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: index9164e9249fd166146864f43fcd1f6506.url(options),
    method: 'get',
})

index9164e9249fd166146864f43fcd1f6506.definition = {
    methods: ["get","head"],
...
index9164e9249fd166146864f43fcd1f6506.url = (options?: RouteQueryOptions) => {
    return index9164e9249fd166146864f43fcd1f6506.definition.url + queryParams(options)
}
...
const index103d80f5cccbc6810db50d59162c9ab3 = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: index103d80f5cccbc6810db50d59162c9ab3.url(options),
    method: 'get',
})

index103d80f5cccbc6810db50d59162c9ab3.definition = {
    methods: ["get","head"],
    url: '/admin123/pages',
} satisfies RouteDefinition<["get","head"]>
...
index103d80f5cccbc6810db50d59162c9ab3.url = (options?: RouteQueryOptions) => {
    return index103d80f5cccbc6810db50d59162c9ab3.definition.url + queryParams(options)
}
...
export const index = {
    '/admin123/page-values': index9164e9249fd166146864f43fcd1f6506,
    '/admin123/pages': index103d80f5cccbc6810db50d59162c9ab3,
}
...
const PageController = { quickStore, index, destroyMany, toggleStatus, create, store, show, edit, update, destroy }
