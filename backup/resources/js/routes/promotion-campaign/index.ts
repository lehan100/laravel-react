...
/**
* @see \App\Http\Controllers\Admin\Promotion\PromotionCampaignController::publicMethod
* @see app/Http/Controllers/Admin/Promotion/PromotionCampaignController.php:205
* @route '/flash-sale/{slug}'
*/
export const publicMethod = (args: { slug: string | number } | [slug: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/flash-sale/{slug}'
*/
publicMethod.url = (args: { slug: string | number } | [slug: string | number ] | string | number, options?: RouteQueryOptions) => {
...
* @route '/flash-sale/{slug}'
*/
publicMethod.get = (args: { slug: string | number } | [slug: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: publicMethod.url(args, options),
    method: 'get',
})
...
* @route '/flash-sale/{slug}'
*/
publicMethod.head = (args: { slug: string | number } | [slug: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: publicMethod.url(args, options),
    method: 'head',
})
...
* @see app/Http/Controllers/Admin/Promotion/PromotionCampaignController.php:192
...
* @see app/Http/Controllers/Admin/Promotion/PromotionCampaignController.php:180
* @route '/admin123/promotion-campaign/{promotion_campaign}'
*/
