...
class SyncFrontendTranslationBundlesTest extends TestCase
{
    #[Test]
    public function it_generates_json_bundles_when_the_job_runs(): void
    {
        $basePath = sys_get_temp_dir().'/frontend-translation-job-'.uniqid('', true);
        ...
        try {
            $job = new SyncFrontendTranslationBundles($basePath);
