...
* @see app/Http/Controllers/Admin/Settings/LabelController.php:28
...
* @see app/Http/Controllers/Admin/Settings/LabelController.php:47
...
* @see app/Http/Controllers/Admin/Settings/LabelController.php:55
* @route '/admin123/labels'
*/
...
* @see app/Http/Controllers/Admin/Settings/LabelController.php:88
...
* @see app/Http/Controllers/Admin/Settings/LabelController.php:96
...
* @see app/Http/Controllers/Admin/Settings/LabelController.php:104
* @route '/admin123/labels/{label}'
*/
...
* @see app/Http/Controllers/Admin/Settings/LabelController.php:112
* @route '/admin123/labels/{label}'
*/
...
const LabelController = { destroyMany, toggleStatus, index, create, store, show, edit, update, destroy }
