...
return [
    ...
    'ai_assistant' => [
        ...
        'chat' => 'Chat',
        'post_assistant' => [
            'name' => 'Trợ lý viết bài AI',
            'created' => 'Tạo batch mới',
            'edit' => 'Chỉnh batch',
            'deleted' => 'Đã xóa group batch thành công.',
            'confirm_delete_batch' => 'Bạn có chắc chắn muốn xóa group batch này không?',
            'topic' => 'Chủ đề',
            'topic_placeholder' => 'Ví dụ: lò nướng bánh pizza, mẹo chọn thiết bị bếp...',
            'quantity' => 'Số bài',
            'generate' => 'Tạo bản nháp',
            'generated' => 'Đã tạo batch bản nháp.',
            'schedule' => 'Lên lịch public',
            'scheduled' => 'Đã lưu lịch public cho batch.',
            'failed_generate' => 'Không thể tạo bản nháp lúc này.',
            'batch_not_found' => 'Không tìm thấy batch bản nháp.',
            'published_at' => 'Thời gian public',
            'drafts' => 'Bản nháp',
            'group_drafts' => 'Bản nháp trong group',
            'customize' => 'Tùy chỉnh',
            'metadata' => 'Thông tin chung',
            'statistics_title' => 'Thống kê nhóm',
            'group_list_title' => 'Danh sách group batch',
            'group_label' => 'Group',
            'category_label' => 'Danh mục',
            'progress_label' => 'Tiến độ',
            'created_label' => 'Ngày tạo',
            'draft_builder' => 'Trình tạo bản nháp AI',
            'saved_groups' => 'Nhóm đã lưu',
            'group_badge' => 'Group',
            'public_progress' => 'Tiến độ public',
            'input_label' => 'Input',
            'output_label' => 'Output',
            'locale_label' => 'Locale',
            'batch_label' => 'Batch',
            ...
            'groups' => 'Groups',
            'groups_hint' => 'Số group batch đang lưu.',
            'total_drafts_hint' => 'Tổng số bản nháp trong tất cả group.',
            'empty_drafts_title' => 'Chưa có bản nháp nào',
            'empty_drafts_create_hint' => 'Hãy tạo một batch để xem danh sách bài viết và chỉnh lịch xuất bản ở đây.',
            'empty_drafts_edit_hint' => 'Group này chưa có bản nháp nào để chỉnh sửa.',
            'empty_groups_title' => 'Chưa có group nào',
            'empty_groups_hint' => 'Batch mới tạo sẽ xuất hiện ở đây để theo dõi tiến độ public theo nhóm.',
            'create_intro_title' => 'Tạo loạt bài có cấu trúc đầy đủ, sẵn sàng chỉnh sửa và lên lịch',
            'create_intro_description' => 'Nhập một chủ đề, hệ thống sẽ tạo nhiều bản nháp khác nhau với góc nhìn riêng, nội dung dài hơn, có mở bài, thân bài, kết luận và định dạng HTML phù hợp cho trình soạn thảo.',
            'input_summary' => 'Chủ đề + số lượng',
            'input_summary_hint' => 'Tạo nhiều bài cùng lúc theo cùng một đề tài.',
            'output_summary' => 'JSON sạch',
            'output_summary_hint' => 'Bài sinh ra được lưu thành batch để lên lịch nhanh.',
            'locale_hint' => 'Nội dung và prompt bám theo ngôn ngữ quản trị hiện tại.',
            'prompt_checklist_title' => 'Prompt checklist',
            'prompt_checklist_description' => 'Mỗi bản nháp sẽ được yêu cầu đủ khung bài viết và văn phong tự nhiên.',
            'prompt_item_unique_angle' => 'Một góc nhìn riêng cho từng bản nháp, tránh lặp ý.',
            'prompt_item_structure' => 'Nội dung dài hơn, có tiêu đề phụ, ví dụ, checklist hoặc FAQ.',
            'prompt_item_html' => 'HTML sạch, phù hợp để dán thẳng vào trình soạn thảo.',
            'create_settings' => 'Cấu hình tạo bài',
            'suggestion' => 'Gợi ý',
            'suggestion_hint' => 'Chủ đề càng cụ thể, bài viết tạo ra càng sâu và sát nhu cầu hơn.',
            'review_title' => 'Review draft',
            'review_heading' => 'Xem và chỉnh sửa bài viết',
            'review_hint' => 'Chỉnh lại nội dung, ảnh đại diện và thời gian public trước khi lên lịch.',
            'content_title' => 'Nội dung bài viết',
            'content_hint' => 'Biên tập bằng TinyMCE, đúng kiểu một bài post hoàn chỉnh.',
            'save_hint' => 'Các thay đổi sẽ được giữ trong batch hiện tại trước khi job public chạy.',
            'featured_image' => 'Ảnh đại diện',
            'insert_image' => 'Chèn ảnh',
            'short_description' => 'Mô tả ngắn',
            'save_changes' => 'Lưu thay đổi',
            'due_now' => 'Đến hạn public',
            'waiting_due' => 'Chờ đến hạn',
            'batch_code_hint' => 'Mã group đang chỉnh sửa.',
            'drafts_hint' => 'Số bản nháp trong batch.',
            'ready_hint' => 'Bản nháp đã tới lịch public.',
            'upcoming_hint' => 'Bản nháp còn ở lịch tương lai.',
            'drafts_created_hint' => 'Số bản nháp đã tạo.',
            'average_hint' => 'Số từ trung bình mỗi bản nháp.',
            'total_words_hint' => 'Tổng độ dài nội dung ước tính.',
            'first_publish_hint' => 'Mốc xuất bản đầu tiên trong batch.',
            'content_title' => 'Nội dung bài viết',
            'insert_image' => 'Chèn ảnh',
            'short_description' => 'Mô tả ngắn',
            'featured_image' => 'Ảnh đại diện',
            ...
            'missing_input' => 'Hãy nhập nội dung ở ngôn ngữ hiện tại trước khi dịch.',
            'no_target_locales' => 'Không có ngôn ngữ đích để dịch.',
            'empty_response' => 'AI chưa trả về bản dịch.',
            'failed_translate' => 'Không thể dịch tự động lúc này.',
        ],
    ],
    'customer_care' => [
            ...
            'ai' => [
                ...
                'seo_check_rules' => [
                    ...
                    'content_depth' => [
                        ...
                        'hint' => 'Nội dung sản phẩm nên có ít nhất 120 từ để đủ ngữ cảnh hữu ích.',
                    ],
                    'status_ok' => 'Đạt',
